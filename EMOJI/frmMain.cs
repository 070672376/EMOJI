...
namespace TestApp
{
    public partial class frmMain
    {
        ...
        private void FillPropertyGrid1(FilterPropertyType filter)
        {
            ...
            // Load IZTOK KADOIČ Properties EMOJI
            // Events
            Form1.CIndexes.EventMouseMoveIndex = Properties.Item.Add("Mouse Move", CEvent.None, false, "Events", "Work with Enum too!", true);
            Form1.CIndexes.EventMouseDownIndex = Properties.Item.Add("Mouse Down", CEvent.None, false, "Events", "Work with Enum too!", true);
            Form1.CIndexes.EventMouseUpIndex = Properties.Item.Add("Mouse Up", CEvent.None, false, "Events", "Work with Enum too!", true);


            Form1.CIndexes.EventPropertiesIndex = Properties.Item.Add("Event", CEvent.None, false, "Simple properties", "Work with Enum too!", true);
            Form1.CIndexes.MouseButtonPropertiesIndex = Properties.Item.Add("Mouse Button", CEnumMouseButton.None, false, "Simple properties", "Work with Enum too!", true);
            Form1.CIndexes.PropertiesIndex = Properties.Item.Add("Binary code filename", "", false, "Binary code filename", "This property is a filename path. It define a custom UITypeConverter that show a OpenFileDialog or a SaveFileDialog when the user press the 3 dots button to edit the value.", true);
            Properties.Item[Properties.Item.Count - 1].UseFileNameEditor = true;
            Properties.Item[Properties.Item.Count - 1].FileNameDialogType = UIFilenameEditor.FileDialogType.LoadFileDialog;
            Properties.Item[Properties.Item.Count - 1].FileNameFilter = "Binary files (*.exe)|*.exe|All files (*.*)|*.*";
        ...
        {
            // Save Binary code filanem
            if (F1.EMOJIDOC != null)
            {
                F1.EMOJIDOC.Emojies[CIndexes.PropertiesEMOJIIndex].BinaryFile = (String)Form1.Properties.Properties.Item[CIndexes.PropertiesIndex].Value;
            }
